...
from LunaRobot.modules.sql import SESSION
...
from LunaRobot.modules.sql.afk_sql import is_afk, set_afk
from LunaRobot.modules.sql.users_sql import get_user_num_chats
from LunaRobot.modules.helper_funcs.chat_status import sudo_plus
from LunaRobot.modules.helper_funcs.extraction import extract_user
...
def info(update: Update, context: CallbackContext):
    ...
    if user.id == OWNER_ID:
        ...
        disaster_level_present = True
         ...
         text += "\n\nOwner Of A Bot. Queen Of @tdrki_1. Bot Name Inspired From 'JoJo'."
         disaster_level_present = True
                    ...
                    [
                        [
                            InlineKeyboardButton(
                                "Health", url="https://t.me/zeinproject/44"),
                            InlineKeyboardButton(
                                "Disaster", url="https://t.me/zeinproject/43")
                        ],
                    ]
                ),
                parse_mode=ParseMode.HTML,
...
def stats(update: Update, context: CallbackContext):
    stats = "<b>╔═━「 Current Luna Statistics 」</b>\n" + "\n".join([mod.__stats__() for mod in STATS])
    result = re.sub(r"(\d+)", r"<code>\1</code>", stats)
    result += "\n<b>╘═━「 Powered By zeinzo 」</b>"
    update.effective_message.reply_text(
        result,
        parse_mode=ParseMode.HTML, 
        disable_web_page_preview=True
...
*What is that health thingy?*
 Come and see [HP System explained](https://t.me/zeinproject/44)
"""
