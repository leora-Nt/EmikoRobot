...
from LunaRobot import telethn as tbot, ubot2
...
async def logo_gen(event):
    ...
    if event.reply_to_msg_id:
        ...
        fpath_ = glob.glob("./LunaRobot/resources/fonts/*")
    ...
    if os.path.exists(flnme):
        await tbot.send_file(
            event.chat_id,
            file=flnme,
            caption="Logo by [Luna Robot](https://t.me/lunatapibot)",
    ...
    if os.path.exists(font_):
        if not font_.startswith("./LunaRobot/resources/fonts"):
            os.remove(font_)
