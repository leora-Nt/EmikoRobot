...
from LunaRobot import pbot as app, SUPPORT_CHAT
from LunaRobot import arq
from LunaRobot.services.keyboard import Ikb
from LunaRobot.utils.pluginhelper import convert_seconds_to_minutes as time_convert, fetch
from LunaRobot.services.tasks import _get_tasks_text, all_tasks, rm_task
from LunaRobot.services.types import InlineQueryResultCachedDocument
from LunaRobot.modules.info import get_chat_info, get_user_info
from LunaRobot.modules.music import download_youtube_audio
from LunaRobot.utils.functions import test_speedtest
from LunaRobot.utils.pastebin import paste
...
async def alive_function(answers):
    ...
    buttons.add(
        InlineKeyboardButton("Main bot", url="https://t.me/lunatapibot"),
        InlineKeyboardButton(
    ...
    msg = f"""
**[Luna Robot ❤️](https://t.me/{SUPPORT_CHAT}):**
**MainBot:** `{bot_state}`
**UserBot:** `{ubot_state}`
...
**Profiles:** [BOT](t.me/{BOT_USERNAME}) | [UBOT](t.me/tdrki_1)
"""
    answers.append(
        InlineQueryResultArticle(
            title="Alive",
