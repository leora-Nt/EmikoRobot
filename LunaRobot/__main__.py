...
from LunaRobot.modules.helper_funcs.chat_status import is_user_admin
from LunaRobot.modules.helper_funcs.misc import paginate_modules
...
buttons = [
    [
        InlineKeyboardButton(text=f"About {dispatcher.bot.first_name}", callback_data="Luna_"),
    ],
    [
...
DONATE_STRING = """Heya, glad to hear you want to donate!
 You can support the project by contacting @tdrki_1 \
    ...
    if query.data == "Luna_":
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="Admins", callback_data="Luna_admin"),
                    InlineKeyboardButton(text="Notes", callback_data="Luna_notes"),
                 ],
                 [
                    InlineKeyboardButton(text="Support", callback_data="Luna_support"),
                    InlineKeyboardButton(text="Credits", callback_data="Luna_credit"),
                 ],
                 [
                    InlineKeyboardButton(text="Source Code", url="https://github.com/zeinzo/LunaRobot"),
                 ],
                 [
                    InlineKeyboardButton(text="Go Back", callback_data="Luna_back"),
                 ]
                ]
            ),
        )
        ...
        query.message.edit_text(
            ...
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [[InlineKeyboardButton(text="Go Back", callback_data="Luna_")]]
            ),
        )
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="zein", url="https://github.com/zeinzo"),
...
def main():
    ...
    about_callback_handler = CallbackQueryHandler(
        Luna_about_callback, pattern=r"Luna_", run_async=True
    )
